...
# Configuration
PACKAGE_NAME="cat.kittyn.selectionhelper"
ROOT_DIR="cat.kittyn.selectionhelper"
REPO_OWNER="kittynXR"
REPO_NAME="selection-helper"
...
3. Find \"cátte — Selection Helper\" and click \"Add\"

### Manual Installation
Download \`$ZIP_FILE\` and extract to your Unity project's \`Packages\` folder."

gh release create "$TAG" \
    --title "cátte — Selection Helper $NEW_VERSION" \
    --notes "$RELEASE_NOTES" \
    "$ZIP_FILE"
